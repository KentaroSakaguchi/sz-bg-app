        ...
        <div className="sticky top-0 z-40 lg:z-50 w-full max-w-8xl mx-auto bg-white flex-none flex">
          <div className="flex-none pl-4 sm:pl-6 xl:pl-8 flex items-center border-b border-gray-200 lg:border-b-0 lg:w-60 xl:w-72">
            <a className="overflow-hidden w-10 md:w-auto" href="/">
              ...
              <svg viewBox="0 0 248 31" className="w-auto h-6">
          ...
          <div className="flex-auto border-b border-gray-200 h-20 flex items-center justify-between px-4 sm:px-6 lg:mx-6 lg:px-0 xl:mx-8">
            ...
            <div className="lg:w-64 pl-8 flex-shrink-0 flex items-center justify-end space-x-6">
              <form className="relative hidden lg:block">
                <label><span className="sr-only">Tailwind CSS Version</span>
                  <select className="appearance-none block bg-transparent pr-7 py-1 text-gray-500 font-medium text-sm focus:outline-none focus:text-gray-900 transition-colors duration-200">
                    <option value="v2">v2.2.16</option>
                    <option value="v1">v1.9.6</option>
                    <option value="v0">v0.7.4</option>
                  </select>
                </label>
                <svg className="w-5 h-5 text-gray-400 absolute top-1/2 right-0 -mt-2.5 pointer-events-none" fill="currentColor">
              ...
              <a href="https://github.com/tailwindlabs/tailwindcss" className="text-gray-400 hover:text-gray-500 transition-colors duration-200">
