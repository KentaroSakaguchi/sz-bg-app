...
export default function termsOfService() {
  return (
    <Layout title="利用規約" noindex={true} description="">
      <div className={style.section}>
        <div className={style.section__inner}>
          <h1 className={style.section__title}>利用規約</h1>
          <div className={style.section__terms}>
            <div className={style.section__termsInner}>
              <ul className={style.section__terms__list}>
                <li className={style.section__termsItem}>
                  この利用規約（以下，「本規約」といいます。）は，株式会社静紅屋（以下，「当社」といいます。）がこのウェブサイト上で提供するサービス（以下，「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下，「ユーザー」といいます。）には，本規約に従って，本サービスをご利用いただきます。
                </li>
                <li className={style.section__termsItem}>
                  第1条（適用）
                  <ol className={style.section__termsDataListList}>
                ...
                <li className={style.section__termsItem}>
                  ...
                  <ol className={style.section__termsDataListList}>
                    ...
                    <li className={style.section__termsDataListItem}>
                      ...
                      <ol className={style.section__termsDataListChildList}>
                        <li className={style.section__termsDataListChildItem}>
                ...
                <li className={style.section__termsItem}>
                  第5条（禁止事項）
                  <p className={style.section__termsItemText}>
                  ...
                  <ol className={style.section__termsDataListList}>
                    ...
                    <li className={style.section__termsDataListList}>
            ...
            <p className={style.section__terms__text}>以上</p>
          </div>
        </div>
      </div>
    </Layout>
