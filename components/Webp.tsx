  ...
  return (
    <div className="relative bg-white overflow-hidden">
          ...
          <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 lg:px-8 xl:mt-28">
            <div className="sm:text-center lg:text-left">
              <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
                <span className="block">画像(JPG、PNG）<br />からWebPへの<br />コンバーター</span>
                <span className="block text-indigo-600 xl:inline">WebP Converter</span>
              </h1>
              <h2 className="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
              画像(JPG、PNG）からWebPへの変換ツールです。
              </h2>
      ...
      <div className="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
        <img className="h-72 w-full object-cover sm:h-72 md:h-96 lg:w-full lg:h-full" src="/iStock-1152109336.webp" alt="" />
      </div>
    </div>
